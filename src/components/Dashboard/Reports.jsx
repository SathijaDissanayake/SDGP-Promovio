...
function Reports() {
  ...
  return (
    <div className="bg-zinc-900 min-h-screen flex flex-col items-center text-white gap-6 px-8 py-12">
      {/* Header */}
      <header className="w-full max-w-7xl px-8 py-6 rounded-lg flex justify-left mb-8 sm:mb-12">
        <h1 className="text-2xl font-bold text-white">Promoivo Performance Report</h1>
      </header>
      ...
      <h2 className="text-xl font-bold text-white mb-4 sm:mb-6">Campaign Performance</h2>

      {/* Campaign Performance Table */}
      <section className="w-full max-w-7xl p-8 rounded-lg shadow-lg overflow-x-auto mb-8 sm:mb-12 
  border-[1px] border-gray-400/30 shadow-[0_0_10px_rgba(255,255,255,0.2)]">
        <table className="w-full border-collapse text-gray-300">
          <thead>
          <tr className="bg-primary text-white text-lg font-semibold uppercase tracking-wide">
            <th className="p-4 text-left sm:text-center rounded-tl-lg">Campaign</th>
            <th className="p-4">Sent</th>
            <th className="p-4">Opens</th>
            <th className="p-4">Clicks</th>
            <th className="p-4">Bounced</th>
            <th className="p-4 rounded-tr-lg">Unsubscribe</th>
          </tr>
          </thead>
          <tbody>
            {campaigns.length > 0 ? (
